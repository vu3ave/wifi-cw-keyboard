...
Keep the two files ( index.h and wifi-keyboard-cw-keyer.ino ) in same folder
before uploading to ESP12.


After uploading the sketch, apply reset to ESP12, this will start AP Mode and create

WiFi Hotspot named "14-dec-2022-5"
...
A web page opens where you can type in Messages in English

>> This messages are are transilated as CW (Telegraphy messages)
...
Any questions about this keyer progamming ask me :

+91 9995957776 (phone/whatsapp) 

or email : vu3ave@gmail.com
